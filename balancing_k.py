...
def classify_sequence(x0, k, check_n=DEFAULT_CHECK_N, print_n=DEFAULT_PRINT_N):
    v = (x0,)
    printed_seq = [v]
    full_seq = [v]
...
class VectorRecurrenceGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Vector Recurrence Hailstone Explorer")
    ...
    def build_controls(self):
        ...
        cycles_button.grid(row=0, column=11, padx=10)
